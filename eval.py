...
# python train.py
# python test.py -i ./data/clickbait17-train-170331 -o output
# python eval.py ./data/clickbait17-train-170331/truth.jsonl ./output/predictions.jsonl output.prototext
